(function () {
    $(function () {
        ...
        _$form.find('button[type="submit"]').click(function (e) {
            ...
            abp.services.app.lessonOfClassRoom.create(formModal).done(function () {
                _$modal.modal('hide');
        ...
        $('.delete-lesson').click(function () {
            ...
            abp.message.confirm(
                ...
                function (isConfirmed) {
                    if (isConfirmed) {
                        abp.services.app.lessonOfClassRoom.delete({
                            id: roleId
                        }).done(function () {
                            location.reload(true);  
                        });
        ...
        $('.edit-lesson').click(function (e) {
            ...
            e.preventDefault();
            abp.ajax({
                url: abp.appPath + 'Lessons/LessonOfClassRoom_EditModal?id=' + classRoomId,
                type: 'POST',
                dataType: 'html',
