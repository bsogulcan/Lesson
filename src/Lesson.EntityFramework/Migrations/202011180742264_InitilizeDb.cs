namespace Lesson.Migrations
{
    ...
    public partial class InitilizeDb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.ExaminationQuestionAnswers",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Answer = c.String(),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_ExaminationQuestionAnswer_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_ExaminationQuestion_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Examination_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Lesson_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .Index(t => t.IsDeleted);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Homework_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClassRooms", t => t.ClassRoom_Id)
                .ForeignKey("dbo.Lessons", t => t.Lesson_Id)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_LessonOfClassRoom_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClassRooms", t => t.ClassRoom_Id)
                .ForeignKey("dbo.Lessons", t => t.Lesson_Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        RollCallType = c.Int(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        DeleterUserId = c.Long(),
                        DeletionTime = c.DateTime(),
                        LastModificationTime = c.DateTime(),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_RollCallDetail_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.RollCalls", t => t.RollCall_Id)
                .ForeignKey("dbo.AbpUsers", t => t.User_Id)
                .Index(t => t.IsDeleted)
                .Index(t => t.RollCall_Id)
                .Index(t => t.User_Id);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_RollCall_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClassRooms", t => t.ClassRoom_Id)
                .ForeignKey("dbo.Lessons", t => t.Lesson_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.StudentOfClassRooms", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.StudentOfClassRooms", "ClassRoom_Id", "dbo.ClassRooms");
            DropForeignKey("dbo.RollCallDetails", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.RollCallDetails", "RollCall_Id", "dbo.RollCalls");
            DropForeignKey("dbo.RollCalls", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.RollCalls", "Lesson_Id", "dbo.Lessons");
            DropForeignKey("dbo.RollCalls", "ClassRoom_Id", "dbo.ClassRooms");
            ...
            DropForeignKey("dbo.LessonOfClassRooms", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.LessonOfClassRooms", "Lesson_Id", "dbo.Lessons");
            DropForeignKey("dbo.LessonOfClassRooms", "ClassRoom_Id", "dbo.ClassRooms");
            DropForeignKey("dbo.Homework", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.Homework", "Lesson_Id", "dbo.Lessons");
            DropForeignKey("dbo.Homework", "ClassRoom_Id", "dbo.ClassRooms");
            DropForeignKey("dbo.Examinations", "User_Id", "dbo.AbpUsers");
            ...
            DropForeignKey("dbo.ExaminationQuestions", "Examination_Id", "dbo.Examinations");
            DropForeignKey("dbo.Examinations", "Lesson_Id", "dbo.Lessons");
            DropForeignKey("dbo.Examinations", "ClassRoom_Id", "dbo.ClassRooms");
            DropForeignKey("dbo.ExaminationQuestionAnswers", "ExaminationQuestion_Id", "dbo.ExaminationQuestions");
            ...
            DropIndex("dbo.StudentOfClassRooms", new[] { "User_Id" });
            DropIndex("dbo.StudentOfClassRooms", new[] { "ClassRoom_Id" });
            DropIndex("dbo.StudentOfClassRooms", new[] { "IsDeleted" });
            DropIndex("dbo.RollCalls", new[] { "User_Id" });
            DropIndex("dbo.RollCalls", new[] { "Lesson_Id" });
            DropIndex("dbo.RollCalls", new[] { "ClassRoom_Id" });
            DropIndex("dbo.RollCalls", new[] { "IsDeleted" });
            DropIndex("dbo.RollCallDetails", new[] { "User_Id" });
            DropIndex("dbo.RollCallDetails", new[] { "RollCall_Id" });
            DropIndex("dbo.RollCallDetails", new[] { "IsDeleted" });
            ...
            DropIndex("dbo.LessonOfClassRooms", new[] { "User_Id" });
            DropIndex("dbo.LessonOfClassRooms", new[] { "Lesson_Id" });
            DropIndex("dbo.LessonOfClassRooms", new[] { "ClassRoom_Id" });
            DropIndex("dbo.LessonOfClassRooms", new[] { "IsDeleted" });
            ...
            DropIndex("dbo.Homework", new[] { "Lesson_Id" });
            DropIndex("dbo.Homework", new[] { "ClassRoom_Id" });
            DropIndex("dbo.Homework", new[] { "IsDeleted" });
            ...
            DropIndex("dbo.Lessons", new[] { "IsDeleted" });
            DropIndex("dbo.Examinations", new[] { "User_Id" });
            DropIndex("dbo.Examinations", new[] { "Lesson_Id" });
            DropIndex("dbo.Examinations", new[] { "ClassRoom_Id" });
            DropIndex("dbo.Examinations", new[] { "IsDeleted" });
            DropIndex("dbo.ExaminationQuestions", new[] { "Examination_Id" });
            DropIndex("dbo.ExaminationQuestions", new[] { "IsDeleted" });
            DropIndex("dbo.ExaminationQuestionAnswers", new[] { "ExaminationQuestion_Id" });
            DropIndex("dbo.ExaminationQuestionAnswers", new[] { "IsDeleted" });
            ...
            DropIndex("dbo.ClassRooms", new[] { "IsDeleted" });
            ...
            DropTable("dbo.StudentOfClassRooms",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentOfClassRoom_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            ...
            DropTable("dbo.LessonOfClassRooms",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_LessonOfClassRoom_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            ...
            DropTable("dbo.ExaminationQuestionAnswers",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_ExaminationQuestionAnswer_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
